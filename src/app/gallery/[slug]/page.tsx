...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        description: artwork.description ?? `${artwork.title} — ${artwork.medium}, ${artwork.dimensions}. By Aline Gordiano.`,
        openGraph: {
    ...
    return (
        <div className="pt-28 pb-24 px-6 lg:px-12 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                {/* Artwork Image */}
                <div className="relative aspect-[4/5] bg-[#EDE8E2] flex items-center justify-center overflow-hidden">
                    {/* Placeholder gradient */}
                    <div
                        className="absolute inset-0 bg-gradient-to-br from-[#D4A080] via-[#C5521A]/30 to-[#EDE8E2] flex items-center justify-center"
                        aria-hidden
                    >
                        <span
                ...
                <div className="flex flex-col gap-6 lg:sticky lg:top-28">
                    ...
                    {artwork.status === 'sold' && (
                        <div className="p-4 border border-[#E5E0D8] text-sm text-[#6B6B6B]" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>
                            This work has been sold. <Link href="/commissions" className="text-[#C5521A] underline underline-offset-2">Commission a similar piece →</Link>
                        </div>
                    )}
                </div>
            </div>
            ...
            {artwork.status !== 'sold' && (
                <div id="enquire" className="mt-24 max-w-2xl">
                    ...
                    <p
                        ...
                        style={{ fontFamily: 'var(--font-inter), sans-serif' }}
                    >
                        Fill in the form below and Aline will be in touch within 2 business days.
                    </p>
